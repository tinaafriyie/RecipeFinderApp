    ...
    LaunchedEffect(recipeId) {
        scope.launch {
            recipeViewModel.getRecipeById(recipeId).onSuccess {
                ...
                ingredients = it.ingredients.ifEmpty { listOf("") }
            }
        }
    }
            ...
            LazyColumn(
                ...
                item {
                    ...
                    val categories = listOf(
                        ...
                        "Seafood", "Vegetarian", "Vegan", "Breakfast", "Lunch",
                        "Dinner", "Snack", "Appetizer", "Side Dish", "Soup",
                        "Salad", "Beverage"
                    )
                ...
                item {
                    ...
                    val cuisines = listOf(
                        ...
                        "Greek", "Indian", "Italian", "Japanese", "Mexican",
                    ...
                    Button(
                        onClick = {
                            user?.let {
                                ...
                                recipeViewModel.updateRecipe(recipeId, updatedRecipe) {
                                    onNavigateBack()
                                }
                            }
                        },
